...
class Life_SpawnRscButton {
	...
	colorBackgroundActive[] = {0.5,0,0,0.7};
...
class Life_RscControlsGroupOneScrollbar : Life_RscControlsGroup {
	class VScrollbar : VScrollbar {
		width = 0.015;
		color[] = {1, 1, 1, 1};
...
class Life_RscHouseShortcutButton {
	fade = 1;
	idc = -1;
	style = 0;
	default = 0;
...
class Life_RscHouseButtonMenu : Life_RscHouseShortcutButton {
	fade = 1;
	idc = -1;
	type = 1;
	style = 2;
...
class Life_RscXListBox {
	...
	soundSelect[] = {"\A3\ui_f\data\sound\RscListbox\soundSelect",0.5,1};
};
...
class Life_RscTree {
    ...
    style = 0;
    font = "PuristaMedium";
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 29) * 1)";
...
class Life_PhoneSliderSettings: life_RscXSliderH {
	color[] = {1,1,1,0.75};
	colorActive[] = {1,1,1,0.75};
	colorDisabled[] = {1,1,1,0.75};
};

class Life_PhoneCheckboxSettings: Life_RscCheckbox {
	strings[] = {OFF};
	checked_strings[] = {ON};
...
class Life_RscListBoxMulti: Life_RscListBox {
    style = "0x10 + 0x20";
};

class LifeRscExitButton: Life_RscActiveText {
	idc = 2;
	style = 48;
	color[] = {1,1,1,0.7};
